...
let nota = 7 ; //digite o valor para seu teste//
if(nota >= 6){
...
let numeroInteiroAleatorio = parseInt(Math.random()* console.log(numeroAleatorio));
// Use o Math.ramdon para gerar um número inteiro entre 1 e 1000 e exiba esse número no console//

letInteiroAleatorioDois = parseInt(Math.random()* console.log(numeroInteiroAleatorioDois));